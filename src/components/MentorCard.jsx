...
export default function MentorCard({
  ...
  return (
    <div className={styles.card} onClick={onCardClick} role="button" tabIndex={0}>
      ...
      <div className={styles.info}>
        ...
        <div className={styles.links}>
          {linkedin && (
            <a href={linkedin} target="_blank" rel="noopener noreferrer" className={`${styles.linkBtn} ${styles.linkedin}`} aria-label={`${name}'s LinkedIn`} onClick={(e) => e.stopPropagation()}>
          ...
          {website && (
            <a href={website} target="_blank" rel="noopener noreferrer" className={`${styles.linkBtn} ${styles.website}`} aria-label={`${name}'s website`} onClick={(e) => e.stopPropagation()}>
          ...
          {github && (
            <a href={github} target="_blank" rel="noopener noreferrer" className={`${styles.linkBtn} ${styles.github}`} aria-label={`${name}'s GitHub`} onClick={(e) => e.stopPropagation()}>
