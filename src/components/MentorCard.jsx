    ...
    <div className={styles.card}>
      ...
      <div className={styles.info}>
        ...
        <div className={styles.links}>
          {linkedin && (
            <a href={linkedin} target="_blank" rel="noopener noreferrer" className={`${styles.linkBtn} ${styles.linkedin}`} aria-label={`${name}'s LinkedIn`}>
          ...
          {website && (
            <a href={website} target="_blank" rel="noopener noreferrer" className={`${styles.linkBtn} ${styles.website}`} aria-label={`${name}'s website`}>
          ...
          {github && (
            <a href={github} target="_blank" rel="noopener noreferrer" className={`${styles.linkBtn} ${styles.github}`} aria-label={`${name}'s GitHub`}>
